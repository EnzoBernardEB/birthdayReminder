...
import com.heroku.birthdayreminder.security.payload.request.LoginRequest;
import com.heroku.birthdayreminder.security.payload.request.SignupRequest;
import com.heroku.birthdayreminder.security.payload.request.TokenRefreshRequest;
import com.heroku.birthdayreminder.security.payload.response.JwtResponse;
import com.heroku.birthdayreminder.security.payload.response.MessageResponse;
import com.heroku.birthdayreminder.security.payload.response.TokenRefreshResponse;
...
public class AuthController {
    ...
    public ResponseEntity<?> authenticateUser(@Valid @RequestBody LoginRequest loginRequest) {
        ...
        JwtResponse jwtResponse = new JwtResponse(jwt, refreshToken.getToken(), userDetails.getId(),
                userDetails.getUsername(), userDetails.getEmail(), roles, userDetails.getBirthdates());
